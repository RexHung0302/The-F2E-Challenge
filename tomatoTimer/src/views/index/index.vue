<template lang="pug">
  .index.row#indexPage
    ...
    // Menu 區塊
    transition(name="fade" mode="out-in")
      .index__leftMenuPart.position-absolute.col-9.h-100(v-if="isMenuShow")
        .row.no-gutters.pl-4
